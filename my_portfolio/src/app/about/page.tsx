...
import { Code, Server, Laptop, Database, BookOpen, GraduationCap, Award, Briefcase, Brain, ChartBar } from 'lucide-react';
function About() {
  const skills = [{
    ...
    description: 'Working with Agentic AI and Machine Learning using Python'
  }];
  const education = [
    {
  ...
  return <div className="bg-[#191624] text-white pt-32 pb-20">
      {/* Background elements */}
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 bg-white/5 border border-white/10 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-300">
                      Agentic AI, Data Science & MERN Stack
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="md:col-span-2 space-y-16">
            <section>
              ...
              {/* <p className="text-gray-300 leading-relaxed mb-8">
                I am a passionate developer with a focus on MERN Stack
                development, creating efficient and scalable web applications.
                I'm also expanding my skills in AI and Data Science, exploring
                how machine learning can enhance web applications and solve
                complex problems. With a strong foundation in both front-end and
                back-end technologies, I aim to deliver innovative solutions
                that meet modern digital needs.
              </p>
              <p className="text-gray-300 leading-relaxed">
                My approach to development combines technical expertise with
                creative problem-solving, allowing me to build applications that
                not only function flawlessly but also provide exceptional user
                experiences. As a fresh graduate and continuous learner, I'm
                constantly exploring new technologies at the intersection of web
                development and artificial intelligence to enhance my skills and
              ...
              <p className="text-gray-300 leading-relaxed mb-8">
                I also work with the MERN Stack to build efficient and scalable web applications.
                 ...
                 solutions that are technically robust as well as user-friendly. </p>
            ...
            <section>
              ...
              <div className="space-y-8">
                {education.map((edu, index) => <div key={index} className="relative pl-8 before:content-[''] before:absolute before:left-0 before:top-2 before:w-3 before:h-3 before:bg-gradient-to-r before:from-orange-400 before:to-pink-500 before:rounded-full after:content-[''] after:absolute after:left-1.5 after:top-5 after:w-[1px] after:h-full after:bg-gradient-to-b after:from-orange-400/50 after:to-transparent">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {skills.map((skill, index) => <div key={index} className="p-6 bg-white/5 border border-white/10 rounded-xl hover:border-orange-500/30 transition-all">
            ...
            <section>
              ...
              <div className="space-y-6">
                {professionalGoals.map((goal, index) => <div key={index} className="p-6 bg-white/5 border border-white/10 rounded-xl hover:border-orange-500/30 transition-all">
